...
<div style="background:#1e4d3a;color:#fff;padding:24px;text-align:center"><h1 style="margin:0">${BRAND_NAME}</h1></div>
<div style="padding:24px;color:#1A2E1F">
<h2 style="color:#1e4d3a">Thank you for your order! 🌿</h2>
...
<p style="font-size:18px;font-weight:700;color:#1e4d3a">Total: ₹${props.total}</p>
<p><strong>Deliver to:</strong><br>${props.addressLine}</p>
<a href="${props.trackUrl}" style="display:inline-block;margin-top:20px;background:#1e4d3a;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none">Track your order</a>
</div></div></body></html>`;
}

...
Describe: page → what you clicked → what happened → what should happen → screenshot.
...
| # | Test | Pass / Fail |
|---|------|-------------|
| 2.1 | Click Shop. Product grid loads with prices. | |
| 2.2 | Search for "tomato". Relevant products appear. | |
| 2.3 | Open a product. Detail page shows image, price, Add to Cart. | |
...
| # | Test | Pass / Fail |
|---|------|-------------|
| 5.1 | My Orders page lists orders after placing one. | |
| 5.2 | Preview banner shows "TEST MODE" when enabled. | |
